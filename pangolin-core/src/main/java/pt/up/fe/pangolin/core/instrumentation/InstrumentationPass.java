...
import pt.up.fe.pangolin.core.instrumentation.granularity.Granularity;
import pt.up.fe.pangolin.core.instrumentation.granularity.GranularityFactory;
...
public class InstrumentationPass implements Pass {
	...
	public static final String HIT_VECTOR_NAME = "$__PANGOLIN_HIT_VECTOR__";
	...
	public Outcome transform(CtClass c) throws Exception {
		...
		initializer.insertBefore(HIT_VECTOR_NAME + " = pt.up.fe.pangolin.core.runtime.Collector.instance().getHitVector(\"" + c.getName() + "\");");
